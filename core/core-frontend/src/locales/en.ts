export default {
  ...
  visualization: {
    ...
    enable_svg_renderer: 'Enable Vector Renderer',
    svg_renderer_tips:
      'Charts will use SVG rendering for high-quality vector graphics, but will increase resource consumption',
  ...
  setting_basic: {
    ...
    spreadsheetQueryLimit: 'Spreadsheet query limit',
  ...
  spreadsheet: {
    ...
    draft_close_title: 'Close configuration',
    draft_close_message:
      'This instance has not retrieved data. Closing it will remove the instance. Continue?',
    draft_close_confirm: 'Close',
    draft_close_cancel: 'Cancel',
    ...
    recover_publish: 'Recover published version',
    recover_publish_confirm:
      'Recovering will overwrite unpublished changes. Recover the published version?',
    recover_publish_success: 'Recovered the published version',
    recover_publish_error: 'Failed to recover the published version',
    cancel_publish_confirm:
      'After unpublishing, this spreadsheet cannot be viewed through official access. Unpublish it?',
    cancel_publish_success: 'Unpublished successfully',
    cancel_publish_error: 'Failed to unpublish',
    saved_unpublished: 'Unpublished changes',
    preview: 'Preview',
    export: 'Export',
    share: 'Share',
    copy: 'Copy',
    ...
    load_failed: 'Failed to load spreadsheet',
    retry: 'Retry',
    render_failed: 'Render failed',
    data_empty: 'No data',
    unknown_load_error: 'Unknown load error',
    preview_load_failed: 'Failed to load spreadsheet "{name}": {reason}',
    ...
    dataset_replacement: {
      ...
      more: 'More',
      component_title: 'Replace Component Dataset',
      current_component_dataset: 'Current component dataset',
      replace_to_dataset: 'Replace with dataset',
      used_fields: 'Fields in use',
      matched_fields: 'Matched fields',
      select_dataset_first: 'Please select a dataset first',
      incomplete_warning: 'The dataset and fields have not been fully replaced',
      confirm: 'Confirm',
      tip: 'Components and fields using each dataset will be updated together.',
      used_dataset: 'Dataset in use',
      used_dataset_count: 'Datasets in use: {count}',
      ...
      search: 'Search',
      search_field: 'Search fields',
      clear_matches_confirm: 'Clear all matched fields?',
      no_search_result: 'No matching fields',
      no_used_dataset: 'No dataset is used in this spreadsheet',
      usage_summary: 'Used by {components} components with {fields} fields',
      unmatched_count: '{count} fields are not matched',
      all_matched: 'All fields are matched',
      replace: 'Replace',
      success: 'Dataset replaced successfully',
      failed: 'Failed to replace dataset',
      refresh_warning: 'Dataset replaced, but {count} components failed to refresh'
    },
    tips: 'Tips',
