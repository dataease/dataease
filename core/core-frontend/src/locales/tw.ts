...
散佈圖（氣泡）圖: {a}（系列名稱），{b}（資料名稱），{c}（數值陣列）, {d}（無）`,
  ...
  free: {
    ...
    batch: '批次',
    resource: '資源',
    view_association: '查看血緣關係',
    quick_sync_tips: '所有儀表板、資料大螢幕、資料集、資料來源，將全部移轉到【遷移資源】資料夾。 ',
    batch_sync_tips:
      '1. 與選取資源相關的儀表板、資料大螢幕、資料集、資料來源，也將一併遷移到對應資源的【遷移資源】資料夾；',
    batch_sync_tips1: '2. 移轉資料夾將同時移轉該資料夾下的子資料夾和資源。 ',
    ...
    batch_sync_confirm: '確定遷移{0} 項目及其相關遊離資源嗎？ ',
    single_sync_confirm: '確定遷移該資源嗎',
    batch_del_confirm: '確定刪除{0} 項資源嗎？ ',
    batch_del_confirm_tips: '資源刪除後，不可撤銷，請謹慎操作。 ',
    del_tips_dataset: '刪除資料集會造成相關資料集失效，確定刪除？ ',
    del_tips_datasource: '有資料集正在使用這些資料來源，刪除後資料集不可用，確定刪除？ ',
    single_del_confirm: '確定刪除該{0}嗎？ ',
    single_del_tips_dataset: '該資料集存在下列血緣關係，刪除會造成相關視圖失效，決定刪除？ ',
    single_del_tips_datasource: '有{0} 個資料集正在使用此資料來源，刪除後資料集不可用，確定刪除？ ',
    folder: '資料夾',
