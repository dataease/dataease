export default {
  ...
  datasource: {
    ...
    ck_ssl_ca: 'SSL CA 憑證',
    ck_ssl_client_cert: 'SSL 客戶端憑證',
    ck_ssl_client_key: 'SSL 客戶端私鑰',
    ck_ssl_upload: '上傳憑證',
    ck_ssl_upload_hint: '支援 .pem/.crt/.cer/.key 格式，上傳後自動填入內容',
    ck_ssl_pem_placeholder: '輸入或上傳 PEM 內容',
    ck_ssl_read_failed: '讀取 SSL 憑證檔案失敗',
  ...
  chart: {
    ...
    chart_box_plot: '箱線圖',
    box_plot_low: '下鬚（非異常最小值）',
    box_plot_q1: '下四分位數（Q1）',
    box_plot_median: '中位數',
    box_plot_quartile_range: '四分位區間（Q1–Q3）',
    box_plot_q3: '上四分位數（Q3）',
    box_plot_high: '上鬚（非異常最大值）',
    box_plot_outlier: '異常值',
    box_plot_samples: '{count} 個樣本',
    box_plot_more_outliers: '另有 {count} 個',
    box_plot_outlier_count: '異常值數量',
    box_plot_show_details: '顯示統計詳情',
    box_plot_details_tip:
      '關閉時顯示中位數、四分位區間和異常值數量；開啟後顯示完整五數統計、異常值數量和異常值明細',
    box_plot_show_outliers: '顯示異常值',
    box_plot_outlier_tip:
      '異常值是小於 Q1 − 1.5×IQR 或大於 Q3 + 1.5×IQR 的原始明細值，其中 IQR = Q3 − Q1。\n例如：Q1 = 10、Q3 = 20，則 IQR = 10，正常範圍為 −5～35；小於 −5 或大於 35 的值會顯示為異常點。',
    box_plot_outlier_color: '異常點顏色',
    box_plot_outlier_follow_series: '跟隨系列',
    box_plot_outlier_custom_color: '自訂顏色',
    box_plot_outlier_size: '異常點大小',
    box_plot_category_tip: '每個類別生成一個箱體，用於比較各類別的資料分佈',
    box_plot_group_tip: '可選；在同一類別下拆分多個箱體進行比較',
    box_plot_value_tip: '使用每條有效明細值計算四分位數，不進行加總或平均聚合',
  ...
  plugin: {
    ...
    'flag-view': '圖表插件',
    'flag-df': '資料填報插件',
    'flag-sync-source': '來源資料來源插件',
    'flag-sync-sink': '目標資料來源插件'
  },
  online_map: {
    geometry: '地理資訊',
    onlinemap: '線上地圖',
    ...
    min_zoom: '最小層級',
    max_zoom: '最大層級',
    zoom_tip: '縮放範圍為 0-24，最多保留 1 位小數；不會增加服務本身不存在的地圖細節',
  ...
  setting_basic: {
    ...
    spreadsheetQueryLimit: '電子表格查詢數量上限',
  ...
  sync_task: {
    ...
    source_field: '來源字段',
    source_field_type: '來源類型',
    field_mapping_blocking_title: '目前有 {0} 個欄位需要處理後才能儲存',
    field_mapping_unknown_detail: '目標類型尚未確認，請選擇目標資料庫支援的欄位類型',
    field_mapping_blocking_save_tip: '還有 {0} 個欄位的目標類型未確認：{1}，請處理後再儲存',
    field_mapping_warning_title: '目前有 {0} 個欄位存在同步風險（確認後可繼續儲存）',
    field_mapping_warning_item: '{0}：{1}',
    field_name_separator: '、',
    field_name_more_suffix: '，另有 {0} 個',
    field_mapping_warning_confirm_title: '存在同步風險',
    field_mapping_warning_confirm_message:
      '目前有 {0} 個欄位存在非阻斷同步風險，詳細資訊已顯示在欄位對應上方。是否仍然儲存？',
    field_mapping_save_anyway: '仍然儲存',
    field_mapping_back_to_check: '返回檢查',
    field_mapping_expand_all: '展開全部（{0} 個欄位）',
    field_mapping_collapse: '收起',
    field_type: '類型',
    field_length: '長度',
    field_precision: '精度',
    field_key: '鍵',
  ...
  spreadsheet: {
    ...
    save: '保存',
    save_success: '保存成功',
    draft_close_title: '關閉配置',
    draft_close_message: '目前實例尚未取得資料，關閉後會清除實例，是否確認？',
    draft_close_confirm: '確認關閉',
    draft_close_cancel: '取消',
    delete_success: '刪除成功',
    name_placeholder: '請輸入名稱',
    name_required: '名稱不能為空',
    dataset_binding: '數據集綁定',
    bind_dataset: '綁定數據集',
    unbind_dataset: '解綁數據集',
    ...
    publish_error: '發布失敗',
    publish_status: '發布狀態',
    recover_publish: '恢復到發布版本',
    recover_publish_confirm: '恢復後，未發布的修改將被覆蓋。確定恢復到發布版本？',
    recover_publish_success: '已恢復到發布版本',
    recover_publish_error: '恢復發布版本失敗',
    cancel_publish_confirm: '取消發布後，該電子表格不能被正式查看。確定取消發布？',
    cancel_publish_success: '取消發布成功',
    cancel_publish_error: '取消發布失敗',
    saved_unpublished: '有未發布修改',
    preview: '預覽',
    export: '匯出',
    share: '分享',
    copy: '複製',
    ...
    discard: '不保存',
    load_error: '加載失敗',
    load_failed: '電子表格載入失敗',
    retry: '重試',
    render_failed: '渲染失敗',
    data_empty: '數據為空',
    unknown_load_error: '未知載入錯誤',
    preview_load_failed: '電子表格「{name}」載入失敗：{reason}',
    save_error: '保存失敗',
    update_success: '更新成功',
    update_error: '更新失敗',
    ...
    dataset_replacement: {
      ...
      more: '更多',
      component_title: '替換元件數據集',
      current_component_dataset: '當前元件數據集',
      replace_to_dataset: '替換到數據集',
      used_fields: '已使用欄位',
      matched_fields: '已匹配欄位',
      select_dataset_first: '請先選擇數據集',
      incomplete_warning: '尚未替換數據集和欄位',
      confirm: '確定',
      tip: '替換後，電子表格中使用該數據集的元件和欄位將同步更新。',
      used_dataset: '已使用數據集',
      used_dataset_count: '已使用數據集：{count}',
      filter_component: '過濾元件',
      target_dataset: '目標數據集',
      select_dataset: '請選擇數據集',
      dataset: '數據集',
      refresh: '刷新',
      no_related_data: '暫無相關資料',
      create_dataset: '新建數據集',
      original_field: '原欄位',
      target_field: '目標欄位',
      field_count: '欄位：{count}',
      select_field: '請選擇欄位',
      search: '搜尋',
      search_field: '搜尋欄位',
      clear_matches_confirm: '確定清空所有已匹配欄位嗎？',
      no_search_result: '暫無搜尋結果',
      no_used_dataset: '目前電子表格未使用數據集',
      usage_summary: '已被 {components} 個元件使用，共 {fields} 個欄位',
      unmatched_count: '還有 {count} 個欄位未匹配',
      all_matched: '欄位已全部匹配',
      replace: '替換',
      success: '數據集替換成功',
      failed: '數據集替換失敗',
      refresh_warning: '數據集已替換，{count} 個元件重新整理失敗，請稍後手動重新整理'
    },
    tips: '提示',
