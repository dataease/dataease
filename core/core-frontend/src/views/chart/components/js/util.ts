...
export const TYPE_CONFIGS = [
  {
    ...
    icon: 'table-normal',
    properties: ['color-selector', 'size-selector-ant-v', 'title-selector-ant-v'],
    propertyInner: {
      'color-selector': [
        'tableHeaderBgColor',
        'tableItemBgColor',
  ...
  },
  {
    ...
    icon: 'table-pivot',
    properties: ['color-selector', 'size-selector-ant-v', 'total-cfg', 'title-selector-ant-v'],
    propertyInner: {
      'color-selector': [
        'tableHeaderBgColor',
        'tableItemBgColor',
  ...
  },
  {
    ...
    propertyInner: {
      ...
      'size-selector-ant-v': ['lineWidth', 'lineSymbol', 'lineSymbolSize', 'lineSmooth'],
      ...
      'legend-selector-ant-v': ['show', 'icon', 'orient', 'textStyle', 'hPosition', 'vPosition']
    }
  },
  {
    render: 'antv',
    ...
    propertyInner: {
      'color-selector': ['value', 'colorPanel', 'customColor', 'alpha', 'gradient'],
      'size-selector-ant-v': ['lineWidth', 'lineSymbol', 'lineSymbolSize', 'lineSmooth'],
      'label-selector-ant-v': ['show', 'fontSize', 'color'],
      'tooltip-selector-ant-v': ['show', 'textStyle'],
      'x-axis-selector-ant-v': [
  ...
  },
  {
    ...
    propertyInner: {
      'color-selector': ['value', 'colorPanel', 'customColor', 'gradient', 'alpha'],
      'size-selector-ant-v': ['lineWidth', 'lineSymbol', 'lineSymbolSize', 'lineSmooth'],
      'label-selector-ant-v': ['show', 'fontSize', 'color'],
      'tooltip-selector-ant-v': ['show', 'textStyle'],
      'x-axis-selector-ant-v': [
  ...
  },
  {
    ...
    propertyInner: {
      'color-selector': ['value', 'colorPanel', 'customColor', 'gradient', 'alpha'],
      'size-selector-ant-v': ['barDefault', 'barGap'],
      'label-selector-ant-v': ['show', 'fontSize', 'color', 'position-v', 'labelContent'],
      'tooltip-selector-ant-v': ['show', 'textStyle'],
      'x-axis-selector-ant-v': [
        'show',
        'position',
  ...
  },
  {
    ...
    propertyInner: {
      'color-selector': ['value', 'colorPanel', 'customColor', 'gradient', 'alpha'],
      'label-selector-ant-v': ['show', 'fontSize', 'color', 'position-h', 'reserveDecimalCount'],
      'tooltip-selector-ant-v': ['show', 'textStyle'],
      'x-axis-selector-ant-v': [
        'show',
        'position',
  ...
  },
  {
    ...
    propertyInner: {
      'color-selector': ['value', 'colorPanel', 'customColor', 'gradient', 'alpha'],
      'label-selector-ant-v': ['show', 'fontSize', 'color', 'position-v', 'reserveDecimalCount'],
      'tooltip-selector-ant-v': ['show', 'textStyle'],
      'x-axis-selector-ant-v': [
        'show',
        'position',
  ...
  },
  {
    ...
    icon: 'word-cloud',
    properties: ['color-selector', 'tooltip-selector-ant-v', 'title-selector-ant-v'],
    propertyInner: {
      'color-selector': ['value', 'custom', 'alpha'],
      'tooltip-selector-ant-v': ['show', 'textStyle'],
      'title-selector-ant-v': [
  ...
  /* 下面是echarts图表类型 */
  {
    ...
    propertyInner: {
      ...
      'title-selector': ['show', 'title', 'fontSize', 'color', 'hPosition', 'isItalic', 'isBolder']
    }
  },
  {
    render: 'echarts',
  ...
  },
  {
    ...
    title: 'chart.chart_gauge',
    icon: 'gauge',
    properties: ['color-selector', 'size-selector', 'label-selector', 'title-selector'],
    propertyInner: {
      'color-selector': ['value', 'custom', 'alpha'],
      'size-selector': ['gaugeMin', 'gaugeMax', 'gaugeStartAngle', 'gaugeEndAngle'],
...

  {
    ...
    propertyInner: {
      'margin-selector': ['marginModel', 'marginTop', 'marginBottom', 'marginLeft', 'marginRight'],
      'color-selector': ['value', 'custom', 'alpha'],
      'size-selector': ['lineWidth', 'lineSymbol', 'lineType', 'lineSymbolSize', 'lineSmooth'],
      ...
      'legend-selector': ['show', 'icon', 'orient', 'textStyle', 'hPosition', 'vPosition']
    }
  },
  {
    render: 'echarts',
  ...
  },
  {
    ...
    propertyInner: {
      ...
      'color-selector': ['value', 'custom', 'alpha'],
      'size-selector': ['mix'],
      'label-selector': ['show', 'fontSize', 'color', 'position-v', 'formatter'],
      'tooltip-selector': ['show', 'trigger', 'textStyle', 'formatter'],
      'x-axis-selector': ['show', 'position', 'name', 'nameTextStyle', 'splitLine', 'axisLabel'],
      'y-axis-selector': [
        'show',
        'position',
        'name',
  ...
  },
  {
    ...
    propertyInner: {
      ...
      'color-selector': ['value', 'custom', 'alpha'],
      'size-selector': ['barDefault', 'barWidth', 'barGap'],
      'label-selector': ['show', 'fontSize', 'color', 'position-h', 'formatter'],
      'tooltip-selector': ['show', 'trigger', 'textStyle', 'formatter'],
      'x-axis-selector': [
        'axisForm',
        'show',
...

  {
    ...
    propertyInner: {
      ...
      'label-selector': ['show', 'labelLine', 'fontSize', 'color', 'position-pie', 'formatter'],
      'tooltip-selector': ['show', 'trigger', 'textStyle', 'formatter'],
      'title-selector': [
        'show',
        'title',
  ...
  },
  {
    ...
    propertyInner: {
      ...
      'label-selector': ['show', 'fontSize', 'color', 'position-pie', 'formatter'],
      'tooltip-selector': ['show', 'trigger', 'textStyle', 'formatter'],
      'title-selector': [
        'show',
        'title',
  ...
  },
  {
    ...
    propertyInner: {
      'color-selector': ['value', 'custom', 'alpha'],
      'size-selector': ['pieInnerRadius', 'pieOuterRadius', 'pieRoseType', 'pieRoseRadius'],
      'label-selector': ['show', 'fontSize', 'color', 'position-pie', 'formatter'],
      'tooltip-selector': ['show', 'trigger', 'textStyle', 'formatter'],
      'title-selector': [
        'show',
  ...
  },
  {
    ...
    propertyInner: {
      ...
      'label-selector': ['show', 'fontSize', 'color', 'position-v', 'formatter'],
      'tooltip-selector': ['show', 'trigger', 'textStyle', 'formatter'],
      'split-selector': ['name', 'axisLine', 'axisLabel', 'splitLine', 'splitArea'],
      'title-selector': [
        'show',
        'title',
        'fontSize',
...

  {
    ...
    propertyInner: {
      'color-selector': ['value', 'custom', 'alpha', 'area-border-color', 'gradient-color'],
      'label-selector': [
        'show',
        'fontSize',
        'color',
      ...
      'tooltip-selector': ['show', 'textStyle', 'formatter'],
      'title-selector': [
        'show',
        'title',
        'fontSize',
