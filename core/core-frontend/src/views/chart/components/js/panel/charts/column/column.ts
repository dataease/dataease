import { Column as G2Column, ColumnOptions } from '@antv/g2plot/lib/plots/column'
 ...
 * 条形图
 */
export class Column extends G2PlotChartView<ColumnOptions, G2Column> {
  drawChart(drawOptions: G2PlotDrawOptions<G2Column>): G2Column {
    if (drawOptions.chart?.data) {
      ...
      drawOptions.chartObj = new G2Column(drawOptions.container, options)
      return drawOptions.chartObj
    }
  }
  constructor() {
    super('column', DEFAULT_DATA_BAR)
  }
}
