...
<template>
  <el-dropdown trigger="click" @command="handleCommand">
    <span class="pivot-table-field-item" :class="{ hidden: field.hidden }">
    ...
    <template #dropdown>
      <el-dropdown-menu>
        <el-dropdown-item v-if="isQuotaField" @click.prevent>
          <el-dropdown
            trigger="hover"
            placement="right-start"
            popper-class="pivot-table-summary-dropdown"
        ...
        <el-dropdown-item v-if="isQuotaField" @click.prevent>
          <el-dropdown
            trigger="hover"
            placement="right-start"
            popper-class="pivot-table-quick-calc-dropdown"
            class="sort-sub-dropdown"
        ...
        <el-dropdown-item @click.prevent :divided="isQuotaField">
          <el-dropdown
            trigger="hover"
            placement="right-start"
            popper-class="pivot-table-sort-dropdown"
            class="sort-sub-dropdown"
            @command="handleSort"
          >
            <span class="inner-dropdown-menu">
        ...
        <el-dropdown-item v-if="isDateField" divided @click.prevent>
          <el-dropdown
            trigger="hover"
            placement="right-start"
            popper-class="pivot-table-date-style-dropdown"
            class="sort-sub-dropdown"
        ...
        <el-dropdown-item v-if="isDateField" @click.prevent>
          <el-dropdown
            trigger="hover"
            placement="right-start"
            popper-class="pivot-table-date-pattern-dropdown"
            class="sort-sub-dropdown"
