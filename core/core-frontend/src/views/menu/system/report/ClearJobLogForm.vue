...
const clearTypeList: Array<ClearTypeOption> = [
  { clearType: "1", label: "last_1_days_log" },
  { clearType: "2", label: "last_1_weeks_log" },
  { clearType: "3", label: "last_1_months_log" },
  { clearType: "4", label: "last_3_months_log" },
  { clearType: "5", label: "last_6_months_log" },
  { clearType: "6", label: "last_1_years_log" },
];
</script>
<template>
  <el-dialog
