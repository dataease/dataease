  ...
  <div class="association-content">
    <div class="search-association_form">
      <el-form inline :model="associationFrom" ref="associationFormRef">
        ...
        <el-form-item
          v-loading="loading"
          :label="t('relation.choose_resource')"
        >
          <el-tree-select
        ...
        <el-form-item>
          <el-button
            :disabled="!associationFrom.value"
            type="primary"
            @click="onSubmit"
      ...
      <div class="mode-switch">
        <el-tooltip
          effect="dark"
          :content="t('relation.list_chart')"
          placement="top"
        >
          <el-icon
            @click="handleActiveIcon('list')"
            :class="activeIcon === 'list' && 'active'"
          >
            <Icon name="icon_view-list_outlined"
              ><icon_viewList_outlined
            /></Icon>
          </el-icon>
        </el-tooltip>
        <el-tooltip
          effect="dark"
          :content="t('relation.mind_map')"
          placement="top"
        >
          <el-icon
        ...
        <template v-if="!showLeft">
          ...
          <div class="info-detail">
            ...
            <div class="value">
              <el-icon>
                <Icon
                  ><component :is="iconMap[currentNode.type]"></component
                ></Icon> </el-icon
            ...
            <div class="relation-detail">
              ...
              <template v-for="type in typeArr" :key="type.value">
                <div class="resource-item_title">
                  <el-icon
                    @click="handleIconClick(type)"
                    :class="!type.active && 'active'"
                  >
                    <Icon name="relation_arrow_icon"
                      ><relation_arrow_icon
                    /></Icon>
                  </el-icon>
                  {{ type.label }} ({{
                    groupByArr.filter((ele) => ele.type === type.value).length
                  }})
                </div>
                <div
                  class="resource-item_list"
                  v-for="ele in groupByArr.filter(
                    (ele) => ele.type === type.value && type.active,
                  )"
                  :key="ele.id"
                >
                  <el-icon>
