...
const search = (pageValid?: boolean) => {
    ...
    queryApi(state.paginationConfig.currentPage, state.paginationConfig.pageSize, buildParam()).then(res => {
    ...
    <div class="de-log-container">
        ...
        >
            ...
            <template v-slot:default="scope">
              <span :class="{'de-log-success': scope.row.success, 'de-log-error': !scope.row.success}" class="de-status">
                <span>{{ scope.row.success ? t('operate_log.success') : t('operate_log.failed') }}</span>
                <el-icon
