  ...
  <div class="authentication-content" v-loading="loading">
    <div class="auth-card-container">
      <div
        ...
        v-for="item in showInfos"
        :key="item.name"
      >
        <div class="inner-card">
          <div class="inner-card-info">
            <span class="card-info-left">
              <span class="card-span">{{ item.name === 'oauth2' ? 'OAuth2' : item.name.toLocaleUpperCase() }}</span>
              <span
                class="card-status"
                :class="{
                ...
                >{{
                  item.valid ? t("datasource.valid") : t("datasource.invalid")
                }}</span
              >
            </span>
            <el-tooltip
          ...
          <div class="inner-card-btn">
            <el-button secondary @click="editInfo(item)">{{
              t("commons.edit")
            }}</el-button>
            <el-button
              ...
              >{{ t("commons.test_connect") }}</el-button
            >
          </div>
        </div>
      </div>
