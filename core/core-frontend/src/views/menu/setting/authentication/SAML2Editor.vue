  ...
  >
    ...
    >
      ...
      <el-form-item label="开启请求签名" prop="wantAuthnRequestsSigned">
        <el-switch
          v-model="state.form.wantAuthnRequestsSigned"
        />
      </el-form-item>

      <el-form-item label="开启断言签名" prop="wantAssertionsSigned">
        <el-switch
          v-model="state.form.wantAssertionsSigned"
        />
      </el-form-item>

      <el-form-item v-if="state.form.wantAuthnRequestsSigned || state.form.wantAssertionsSigned" label="SP PrivateKey" prop="privateKey">
        <el-input
      ...
      <el-form-item v-if="state.form.wantAuthnRequestsSigned || state.form.wantAssertionsSigned" label="SP Certificate" prop="certificate">
        <el-input
    ...
    <template #footer>
      <span class="dialog-footer">
        <el-button secondary @click="resetForm(samlForm)">{{
          t("common.cancel")
        }}</el-button>
