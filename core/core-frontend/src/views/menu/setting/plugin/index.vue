<template>
  ...
  <div class="plugin-container">
    <el-scrollbar>
      ...
      <div
        v-if="!Object.keys(state.pluginMap)?.length"
        class="empty-plugin-div"
      >
        <el-empty
      ...
      <div v-else class="plugin-scroller">
        <div
          v-for="(list, key) in state.pluginMap"
          :key="key"
          class="plugin-flag-container"
        >
...
import { loadPluginApi, PluginItem, unInstallApi } from "./data";
