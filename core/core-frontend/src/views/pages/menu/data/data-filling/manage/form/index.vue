...
import RowAuth from '@/views/menu/data/data-filling/manage/form/data-fill-tree/auth-tree/RowAuth.vue'

import { computed, nextTick, onMounted, provide, ref, watch } from 'vue'
import { ElIcon, ElMessage, ElMessageBox } from 'element-plus-secondary'
import router from '@/router'
import { useI18n } from '@/hooks/web/useI18n'
import DataFillingFormSave from '@/views/menu/data/data-filling/manage/form/DataFillingFormSave.vue'
import SelectDetailColumns from '@/views/menu/data/data-filling/manage/form/SelectDetailColumns.vue'
import MoreDetailColumns from '@/views/menu/data/data-filling/manage/form/MoreDetailColumns.vue'
...
function doEditBindColumn() {
  optionForm.value?.validate(valid => {
    if (valid) {
      loading.value = true
              ...
              <template #item="{ element, index }">
                ...
                >
                  ...
                  <el-form-item prop="value" class="form-item no-margin-bottom">
                    ...
                    >
                      <div
                        style="width: 100%; display: flex; margin-top: 8px; padding: 8px"
