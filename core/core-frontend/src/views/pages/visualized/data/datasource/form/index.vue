...
import type { DsType } from '@/views/visualized/data/datasource/form/DsTypeList.vue'
import DsTypeList from '@/views/visualized/data/datasource/form/DsTypeList.vue'
import { useI18n } from '@/hooks/web/useI18n'
import EditorDetail from '@/views/visualized/data/datasource/form/EditorDetail.vue'
import ExcelDetail from '@/views/visualized/data/datasource/form/ExcelDetail.vue'
import {
  save,
  update,
  validate,
...
import type { Param } from '@/views/visualized/data/datasource/form/ExcelDetail.vue'
import type {
  Configuration,
  ApiConfiguration,
  SyncSetting
} from '@/views/visualized/data/datasource/form/option'
import { dsTypes, typeList, nameMap } from '@/views/visualized/data/datasource/form/option'
import { useRouter } from 'vue-router_2'
import { uuid } from 'vue-uuid'
import { useEmitt } from '@/hooks/web/useEmitt'
import FinishPage from '@/views/visualized/data/datasource/FinishPage.vue'
