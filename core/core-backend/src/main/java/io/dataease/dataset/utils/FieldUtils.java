...
public class FieldUtils {
    public static int transType2DeType(final String type) {
        List<String> text = Arrays.asList("CHAR", "VARCHAR", "TEXT", "TINYTEXT", "MEDIUMTEXT", "LONGTEXT", "LONGVARCHAR", "LONGNVARCHAR", "LONG VARCHAR", "LONG VARGRAPHIC", "ENUM", "ANY", "STRING", "POINT", "INT4RANGE", "INTERVAL");
