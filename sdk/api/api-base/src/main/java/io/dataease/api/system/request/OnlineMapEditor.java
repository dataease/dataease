...
public class OnlineMapEditor implements Serializable {
    ...
    @Schema(description = "瓦片服务地址", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private String tileUrl;
    @Schema(description = "矢量地图 Style JSON 地址", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Schema(description = "自定义地图最小缩放层级", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private String tileMinZoom;
    @Schema(description = "自定义地图最大缩放层级", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
