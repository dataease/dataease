...
import io.datains.commons.utils.CompressUtils;
import io.datains.commons.utils.MybatisInterceptorConfig;
import io.datains.interceptor.MybatisInterceptor;
...
@Configuration
@MapperScan(basePackages = {"io.datains.base.mapper", "io.datains.plugins"}, sqlSessionFactoryRef = "sqlSessionFactory")
