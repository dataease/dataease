package io.datains.map.utils;

import cn.hutool.core.collection.CollectionUtil;
import cn.hutool.core.io.file.FileWriter;
import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONUtil;
import io.datains.base.domain.AreaMapping;
import io.datains.base.domain.AreaMappingExample;
import io.datains.base.mapper.AreaMappingMapper;
import io.datains.commons.utils.LogUtil;
import io.datains.map.dto.entity.*;
import io.datains.map.dto.entity.Properties;
import io.datains.map.dto.response.MapResponse;
import io.datains.map.dto.response.MapResultDto;
import io.datains.map.dto.entity.*;
...
public class MapUtils {
    ...
    public static Feature buildFeature(District district, AreaEntity areaEntity) {
        String type = "Feature";
        io.datains.map.dto.entity.Properties properties = new Properties();
