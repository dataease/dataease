          ...
          >
            <div style="padding: 6px 10px;">
              <div>
                ...
                <el-select v-model="colorForm.value" :placeholder="$t('chart.pls_slc_color_case')" size="mini"
                           @change="changeColorOption">
                  <el-option v-for="option in colorCases" :key="option.value" :label="option.name" :value="option.value"
              ...
              <div style="display: flex;align-items: center;margin-top: 10px;">
                ...
                <span>
                    <el-radio-group v-model="customColor" class="color-type">
                      <el-radio v-for="(c,index) in colorForm.colors" :key="index" :label="c" style="padding: 2px;"
              ...
              <div style="display: flex;align-items: center;margin-top: 10px;">
                ...
                <span>
                    <el-color-picker v-model="customColor" class="color-picker-style" :predefine="predefineColors"
