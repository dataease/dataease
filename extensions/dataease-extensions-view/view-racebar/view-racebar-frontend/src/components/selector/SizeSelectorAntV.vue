    ...
    <el-col>
      <el-form ref="sizeFormLine" :model="sizeForm" label-width="80px" size="mini">
        ...
        <el-form-item :label="$t('chart.not_alpha')" class="form-item form-item-slider">
         ...
         <el-form-item v-if="sizeForm.scatterSymbol && sizeForm.scatterSymbol !== 'marker'" :label="$t('plugin_view_racebar.border')" class="form-item form-item-slider">
...
export default {
  ...
  data() {
    return {
      ...
      lineSymbolOptions: [
        { name: this.$t('plugin_view_racebar.marker'), value: 'marker' },
        ...
        { name: this.$t('plugin_view_racebar.pentagon'), value: 'pentagon' },
        { name: this.$t('plugin_view_racebar.hexagon'), value: 'hexagon' },
        { name: this.$t('plugin_view_racebar.octagon'), value: 'octogon' },
        { name: this.$t('plugin_view_racebar.hexagram'), value: 'hexagram' },
