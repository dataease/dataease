...
<script>
import {CHART_FONT_FAMILY, CHART_FONT_LETTER_SPACE, COLOR_PANEL, DEFAULT_TITLE_STYLE} from '../../utils/map'
  ...
  methods: {
    ...
    changeTitleStyle(modifyName) {
      if (!this.batchOptStatus) {
        ...
        if (this.checkViewTitle('update', this.chart.id, this.titleForm.title)) {
