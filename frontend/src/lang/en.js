export default {
  ...
  chart: {
    ...
    chart_card: 'KPI Card',
    chart_bar: 'Base Bar',
    chart_column: '3D Histogram',
    chart_bar_stack: 'Stack Bar',
    chart_column_stack: 'Stacked 3D Histogram',
    ...
    chart_pie: 'Pie',
    chart_3Dpie: '3D Pie',
    chart_arcgis_map: 'Map',
    chart_pie_rose: 'Rose Pie',
    chart_funnel: 'Funnel',
    chart_3dfunnel: '3D Funnel',
    chart_3dpyramid: '3D Pyramid',
    chart_3dscatter: '3D Scatter',
    chart_radar: 'Radar',
    chart_gauge: 'Gauge',
    chart_map: 'Map',
  ...
  panel: {
    ...
    box_width: 'Component width',
    box_height: 'Component height',
    background: 'Background',
    component_style: 'component Style',
    rotate_pictures: 'rotate pictures',
    Number_of_rotation_shows: 'Number of rotation shows',
