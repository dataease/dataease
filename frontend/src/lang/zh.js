export default {
  ...
  chart: {
    ...
    pie_inner_radius: '内径',
    pie_outer_radius: '外径',
    pie_circle_center_left: '圆心左偏移(%)',
    pie_circle_center_top: '圆心上偏移(%)',
    funnel_width: '宽度',
    line_smooth: '平滑折线',
    title_style: '标题样式',
    text_fontsize: '字体大小',
    ...
    text_margin_top: '顶部外边距',
    text_margin_bottom: '底部外边距',
    text_margin: '图例间距',
    text_pos_left: '左',
    text_pos_center: '中',
    text_pos_right: '右',
    ...
    inner_ring_color: '内环颜色',
    outer_ring_color: '外环颜色',
    quota_color: '值颜色',
    ...
    axias_name_left: '名称左移',
    axias_name_top: '名称上移',
    axias_name_Bottom: '名称下移',
    axias_name_right: '名称右移',
    ...
    arc_map_update: '地图图层',
    arc_map_url: '地图serve',
    drag_block_arc_map_info: '地图信息',
    drag_block_arc_map_coordinate: '地图坐标',
    ...
    pop_title_position: '标题位置',
    pop_content_color: '内容字体颜色',
    pop_content_background: '内容背景颜色',
    pop_content_lineHeight: '内容行高',
    // pop_content_border_style: '下划线样式',
    pop_content_border_color: '下划线颜色',
    // pop_content_border_width: '下划线宽度',
