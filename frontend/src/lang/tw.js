export default {
  ...
  chart: {
    ...
    chart_funnel: '漏鬥圖',
    chart_3dfunnel: '3D 漏鬥圖',
    chart_3dpyramid: '3D 金字塔圖',
    chart_3dscatter: '3D 散點圖',
    chart_radar: '雷達圖',
    chart_gauge: '儀錶盤',
    chart_map: '地圖',
    dateStyle: '日期顯示',
  ...
  wizard: {
    ...
    contact_us: '聯繫我們',
    demo_video_hint: '如何3分鐘製作一個DataIns 數據看闆、並分享給他人',
    online_document_hint: '涵蓋DataIns的安裝步驟、用戶手冊、使用教程、常見問題的解決方案、以及二次開發等',
    teaching_video_bottom_hint: '更多視頻資料',
    enterprise_edition_hint1: '提供企業級應用場景 X-Pack 增強包',
    enterprise_edition_hint2: '提供高等級原廠服務支持',
    enterprise_edition_hint3: '提供 DataIns 最佳實踐建議',
