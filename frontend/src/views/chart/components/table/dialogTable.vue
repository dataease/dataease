<template>
  <div ref="tableContainer" :style="bg_class" style="width: 100%;height: 100%;overflow: hidden;">
    <el-row style="height: 100%;padding-bottom:10px">
      ...
      <div class="content" :style="boxHeight">
...
export default {
  ...
  computed: {
    ...
    boxHeight() {
      const style = {}
      if (this.title_show) {
        style.height = (this.element.style.height - this.titleHeight - 35) + 'px'
      } else {
        style.height = (this.element.style.height - this.titleHeight - 5) + 'px'
      }
    ...
    initStyle() {
      ...
      if (this.chart.customAttr) {
        ...
        if (customAttr.size) {
          ...
          this.titleHeight = customAttr.size.tableTitleHeight
      ...
      if (this.title_show) {
        this.box_class.height = (this.element.style.height - 35 - keyHeigh) + 'px'
      } else {
